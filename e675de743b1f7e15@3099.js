...
# NIFTY Index Sectorwise Performance

This chart animates the value (in Rupees) of the top 12 sectors of Indian Stock Market from April 2023 to April 2024. The indices of each sector are compared to know the highest performing sector in the year. Color indicates sector. The inspiration of the bar chart race and the source code can be found here: [the explainer](/d/e9e3929cf7c50b45). Data source: [NSE India](https://www.nseindia.com/reports-indices-historical-index-data)`
)}

function _q3FinalData(__query,FileAttachment,invalidation){return(
__query(FileAttachment("Q3 Final Data.csv"),{from:{table:"Q3 Final Data"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation)
)}

function _data(FileAttachment){return(
FileAttachment("Q3 Final Data.csv").csv({typed: true})
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["Q3 Final Data.csv", {url: new URL("./files/e230e03bbe3c9f32d1e18c50230e836c4df98ca373c8f8f8c5a984e67ade742d13691b3658777d1bc5bce758a2988659a003c55b702b56313fb48d4df67b9946.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("q3FinalData")).define("q3FinalData", ["__query","FileAttachment","invalidation"], _q3FinalData);
